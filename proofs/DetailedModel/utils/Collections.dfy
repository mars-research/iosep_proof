...
lemma Lemma_Map_Equality2<T, U>(m1:map<T,U>, m2:map<T,U>)
...
lemma Lemma_SetAnd_Equality<T>(s:set<T>, s1:set<T>, s2:set<T>)
    requires forall e :: e in s ==> e in s1 || e in s2
    requires forall e :: e in s1 || e in s2 ==> e in s
