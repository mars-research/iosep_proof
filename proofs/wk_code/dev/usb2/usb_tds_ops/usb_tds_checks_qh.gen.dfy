...
function method{:opaque} va_code_usbtd_verify_qh32():va_code
{
  va_Block(va_CCons(va_code_PUSH_OneReg(va_op_reg_reg(EBP)),
    ...
    * ARCH_WORD_BYTES), va_CCons(va_IfElse(va_cmp_ne(va_op_cmp_reg(ESI),
    ...
    va_CCons(va_code__usbtd_verify_qh32_step1_to_step4(),
...
lemma{:timeLimitMultiplier 90} va_lemma_usbtd_verify_qh32(va_b0:va_codes, va_s0:va_state,
  va_sN:va_state)
  returns (va_bM:va_codes, va_sM:va_state)
  requires va_require(va_b0, va_code_usbtd_verify_qh32(), va_s0, va_sN)
  ...
  requires var stack_req_space := 7 * ARCH_WORD_BYTES + 16 * ARCH_WORD_BYTES +
  ...
  ensures  var drv_id := stack_get_val(va_get_mem(va_s0), va_get_reg(ESP, va_s0)); var td_slot :=
    ...
    usbtd_map_get_wimpdrv_slotid(va_get_globals(va_s0), td_slot); var drv_pid :=
    wimpdrv_get_pid(va_get_globals(va_s0), drv_slot).v;
    WK_USBTD_Map_SecureGlobalVarValues_qh32(va_get_globals(va_s0), td_slot))
...
{
  reveal_va_code_usbtd_verify_qh32();
  ...
  if (va_cond_c14)
  {
    ...
    assert globals1 == va_get_globals(va_old_s);  // line 125 column 9 of file .\dev/usb2/usb_tds_ops/usb_tds_checks_qh.vad
    ...
    if (va_cond_c24)
    {
      ...
      assert globals2 == va_get_globals(va_old_s);  // line 138 column 13 of file .\dev/usb2/usb_tds_ops/usb_tds_checks_qh.vad
      ...
      if (va_cond_c35)
      {
        ...
        assert globals3 == va_get_globals(va_old_s);  // line 151 column 17 of file .\dev/usb2/usb_tds_ops/usb_tds_checks_qh.vad
        ...
        if (va_cond_c47)
        {
          ...
          if (va_cond_c50)
          {
            ...
            ghost var va_b58, va_s58 := va_lemma__usbtd_verify_qh32_step1_to_step4(va_b57, va_s57,
              va_s50);
            ...
            assert globals4 == va_get_globals(va_old_s);  // line 166 column 25 of file .\dev/usb2/usb_tds_ops/usb_tds_checks_qh.vad
            ...
            if (va_cond_c63)
            {
              ...
              if (va_cond_c72)
              {
                ...
                assert Is_USBTD_NotModifyUSBPDevsAddrs(globals5, td_slot);  // line 180 column 33 of file .\dev/usb2/usb_tds_ops/usb_tds_checks_qh.vad
                assert Is_USBTD_NotModifyUSBPDevsAddrs(va_get_globals(va_old_s), td_slot);  // line 181 column 33 of file .\dev/usb2/usb_tds_ops/usb_tds_checks_qh.vad
...
function method{:opaque} va_code__usbtd_verify_qh32_step1():va_code
{
  va_Block(va_CCons(va_code_PUSH_OneReg(va_op_reg_reg(EBP)),
    va_CCons(va_code_MOV_ToReg(va_op_reg_reg(EBP), va_op_word_reg(ESP)),
...
lemma va_lemma__usbtd_verify_qh32_step1(va_b0:va_codes, va_s0:va_state, va_sN:va_state)
  returns (va_bM:va_codes, va_sM:va_state)
  requires va_require(va_b0, va_code__usbtd_verify_qh32_step1(), va_s0, va_sN)
  ensures  va_ensure(va_b0, va_bM, va_s0, va_sM, va_sN)
  requires va_get_ok(va_s0)
  ensures  va_get_ok(va_sM)
  requires InstSaneState(va_s0)
  ...
  ensures  var drv_pid := stack_get_val(va_get_mem(va_s0), va_get_reg(ESP, va_s0)); var td_slot :=
    ...
    p__usbtd_verify_qh32_step1_OnSuccessCheck(va_get_globals(va_s0), drv_pid, td_slot)
  ensures  va_get_reg(ESI, va_sM) == va_get_reg(ESI, va_s0)
  ensures  va_get_reg(EDI, va_sM) == va_get_reg(EDI, va_s0)
  ensures  va_get_reg(ESP, va_sM) == va_get_reg(ESP, va_s0)
  ensures  va_get_reg(EBP, va_sM) == va_get_reg(EBP, va_s0)
...
{
  reveal_va_code__usbtd_verify_qh32_step1();
  var va_old_s:va_state := va_s0;
  ghost var va_ltmp1, va_cM:va_code, va_ltmp2 := va_lemma_block(va_b0, va_s0, va_sN);
  va_sM := va_ltmp1;
  va_bM := va_ltmp2;
  var va_b1:va_codes := va_get_block(va_cM);
  reveal_p__usbtd_verify_qh32_step1_OnSuccessCheck();
...
function method{:opaque} va_code__usbtd_verify_qh32_step2():va_code
{
  va_Block(va_CCons(va_code_PUSH_OneReg(va_op_reg_reg(EBP)),
    va_CCons(va_code_MOV_ToReg(va_op_reg_reg(EBP), va_op_word_reg(ESP)),
    va_CCons(va_code_PUSH_Reg1ToReg6(), va_CCons(va_code_Load(va_op_word_reg(ESI),
    va_op_word_reg(EBP), 2 * ARCH_WORD_BYTES),
    va_CCons(va_code_PUSH_VOID((FFI_USBTD_Qh32_ParseTDPtrs_ReturnWords - 1) * ARCH_WORD_BYTES),
    va_CCons(va_code_PUSH(va_op_word_reg(ESI)), va_CCons(va_code_CALL_USBTD_QH32_ParseTDPointers(),
    va_CCons(va_code_MOV_ToReg(va_op_reg_reg(EAX), va_const_word(TRUE)),
    va_CCons(va_code_Load(va_op_word_reg(ESI), va_op_word_reg(EBP), 1 * ARCH_WORD_BYTES),
    va_CCons(va_code_Load(va_op_word_reg(EDI), va_op_word_reg(ESP), 3 * ARCH_WORD_BYTES),
    ...
    va_Block(va_CNil())), va_CCons(va_code_Load(va_op_word_reg(EDI), va_op_word_reg(ESP), 4 *
    ...
    va_CCons(va_IfElse(va_cmp_ne(va_op_cmp_reg(EBX), va_const_cmp(TRUE)),
    va_Block(va_CCons(va_code_MOV_ToReg(va_op_reg_reg(EAX), va_const_word(FALSE)), va_CNil())),
    va_Block(va_CNil())), va_CCons(va_code_Load(va_op_word_reg(EDI), va_op_word_reg(ESP), 5 *
    ARCH_WORD_BYTES), va_CCons(va_code_Load(va_op_word_reg(EDX), va_op_word_reg(ESP), 2 *
    ARCH_WORD_BYTES),
    va_CCons(va_code_usbtd_verify_td32_check_next_slot_and_tflag(va_op_reg_reg(ESI),
    va_op_reg_reg(EDI), va_op_reg_reg(EDX), va_op_reg_reg(EBX)),
    va_CCons(va_IfElse(va_cmp_ne(va_op_cmp_reg(EBX), va_const_cmp(TRUE)),
    va_Block(va_CCons(va_code_MOV_ToReg(va_op_reg_reg(EAX), va_const_word(FALSE)), va_CNil())),
    va_Block(va_CNil())), va_CCons(va_code_POP_VOID(FFI_USBTD_Qh32_ParseTDPtrs_ReturnWords *
...
lemma{:timeLimitMultiplier 20} va_lemma__usbtd_verify_qh32_step2(va_b0:va_codes, va_s0:va_state,
  va_sN:va_state)
  returns (va_bM:va_codes, va_sM:va_state)
  requires va_require(va_b0, va_code__usbtd_verify_qh32_step2(), va_s0, va_sN)
  ensures  va_ensure(va_b0, va_bM, va_s0, va_sM, va_sN)
  requires va_get_ok(va_s0)
  ensures  va_get_ok(va_sM)
  requires InstSaneState(va_s0)
  ...
  requires var stack_req_space := 10 * ARCH_WORD_BYTES + WK_STACK_FOR_EXTERNEL_FUNCS_SZ +
    FFI_USBTD_Qh32_ParseDataBufPtrs_ReturnWords * ARCH_WORD_BYTES; IsAddrInStack(va_get_reg(ESP,
  ...
  ensures  var drv_pid := stack_get_val(va_get_mem(va_s0), va_get_reg(ESP, va_s0)); var td_slot :=
    stack_get_val(va_get_mem(va_s0), va_get_reg(ESP, va_s0) + 1 * ARCH_WORD_BYTES); var ret:word :=
    stack_get_val(va_get_mem(va_sM), va_get_reg(ESP, va_sM)); ret == TRUE ==>
    p__usbtd_verify_qh32_step2_OnSuccessCheck(va_get_globals(va_s0), drv_pid, td_slot)
  ensures  va_get_reg(ESI, va_sM) == va_get_reg(ESI, va_s0)
  ensures  va_get_reg(EDI, va_sM) == va_get_reg(EDI, va_s0)
  ensures  va_get_reg(ESP, va_sM) == va_get_reg(ESP, va_s0)
  ensures  va_get_reg(EBP, va_sM) == va_get_reg(EBP, va_s0)
  ...
  ensures  va_state_eq(va_sM, va_update_reg(EBP, va_sM, va_update_reg(ESP, va_sM,
    ...
    va_update_mem(va_sM, va_update_ok(va_sM, va_s0)))))))))))
{
  reveal_va_code__usbtd_verify_qh32_step2();
  var va_old_s:va_state := va_s0;
  ghost var va_ltmp1, va_cM:va_code, va_ltmp2 := va_lemma_block(va_b0, va_s0, va_sN);
  va_sM := va_ltmp1;
  va_bM := va_ltmp2;
  var va_b1:va_codes := va_get_block(va_cM);
  reveal_p_ffi_usbtd_qh32_parseTDPtrs_retval();
  reveal_p__usbtd_verify_qh32_step2_OnSuccessCheck();
  ...
  ghost var va_b14, va_s14 := va_lemma_PUSH_VOID(va_b12, va_s12, va_sM,
    (FFI_USBTD_Qh32_ParseTDPtrs_ReturnWords - 1) * ARCH_WORD_BYTES);
  ghost var va_b15, va_s15 := va_lemma_PUSH(va_b14, va_s14, va_sM, va_op_word_reg(ESI));
  ghost var va_b16, va_s16 := va_lemma_CALL_USBTD_QH32_ParseTDPointers(va_b15, va_s15, va_sM);
  ...
  ghost var va_b36, va_s36 := va_lemma_Load(va_b31, va_s31, va_sM, va_op_word_reg(EDI),
    va_op_word_reg(ESP), 5 * ARCH_WORD_BYTES);
  ghost var va_b37, va_s37 := va_lemma_Load(va_b36, va_s36, va_sM, va_op_word_reg(EDX),
    va_op_word_reg(ESP), 2 * ARCH_WORD_BYTES);
  ghost var va_b38, va_s38 := va_lemma_usbtd_verify_td32_check_next_slot_and_tflag(va_b37, va_s37,
    va_sM, va_op_reg_reg(ESI), va_op_reg_reg(EDI), va_op_reg_reg(EDX), va_op_reg_reg(EBX));
  ghost var va_s39, va_c39, va_b39 := va_lemma_block(va_b38, va_s38, va_sM);
  ...
  if (va_cond_c39)
  {
    ...
    ghost var va_b42, va_s42 := va_lemma_MOV_ToReg(va_b41, va_s40, va_s39, va_op_reg_reg(EAX),
      va_const_word(FALSE));
    va_s39 := va_lemma_empty(va_s42, va_s39);
  }
  else
  {
    ghost var va_b43 := va_get_block(va_get_ifFalse(va_c39));
    va_s39 := va_lemma_empty(va_s40, va_s39);
  }
  ghost var va_b44, va_s44 := va_lemma_POP_VOID(va_b39, va_s39, va_sM,
    FFI_USBTD_Qh32_ParseTDPtrs_ReturnWords * ARCH_WORD_BYTES);
  ghost var va_s45, va_c45, va_b45 := va_lemma_block(va_b44, va_s44, va_sM);
  ghost var va_cond_c45, va_s46:va_state := va_lemma_ifElse(va_get_ifCond(va_c45),
    va_get_ifTrue(va_c45), va_get_ifFalse(va_c45), va_s44, va_s45);
  if (va_cond_c45)
  {
    ghost var va_b47 := va_get_block(va_get_ifTrue(va_c45));
    ghost var va_b48, va_s48 := va_lemma_Store(va_b47, va_s46, va_s45, va_op_word_reg(EBP),
      ARCH_WORD_BYTES, va_const_word(TRUE));
    va_s45 := va_lemma_empty(va_s48, va_s45);
  }
  else
  {
    ghost var va_b49 := va_get_block(va_get_ifFalse(va_c45));
    ghost var va_b50, va_s50 := va_lemma_Store(va_b49, va_s46, va_s45, va_op_word_reg(EBP),
      ARCH_WORD_BYTES, va_const_word(FALSE));
    va_s45 := va_lemma_empty(va_s50, va_s45);
  }
  ghost var va_b51, va_s51 := va_lemma_POP_Reg1ToReg6(va_b45, va_s45, va_sM);
  ghost var va_b52, va_s52 := va_lemma_POP_OneReg(va_b51, va_s51, va_sM, va_op_reg_reg(EBP));
  Lemma_modify_regs_stateeq(va_old_s, va_s52);
  va_sM := va_lemma_empty(va_s52, va_sM);
}
//--
//-- _usbtd_verify_qh32_step3

function method{:opaque} va_code__usbtd_verify_qh32_step3():va_code
{
  va_Block(va_CCons(va_code_PUSH_OneReg(va_op_reg_reg(EBP)),
    va_CCons(va_code_MOV_ToReg(va_op_reg_reg(EBP), va_op_word_reg(ESP)),
    va_CCons(va_code_PUSH_Reg1ToReg6(), va_CCons(va_code_Load(va_op_word_reg(ESI),
    va_op_word_reg(EBP), 1 * ARCH_WORD_BYTES),
    va_CCons(va_code_PUSH_VOID((FFI_USBTD_Qh32_ParseTargetUSBDevID_ReturnWords - 1) *
    ARCH_WORD_BYTES), va_CCons(va_code_PUSH(va_op_word_reg(ESI)),
    va_CCons(va_code_CALL_USBTD_QH32_ParseTargetUSBDevID(),
    va_CCons(va_code_Load(va_op_word_reg(EDI), va_op_word_reg(ESP), 0),
    va_CCons(va_code_Load(va_op_word_reg(EDX), va_op_word_reg(ESP), ARCH_WORD_BYTES),
    va_CCons(va_code_Load(va_op_word_reg(ECX), va_op_word_reg(ESP), 2 * ARCH_WORD_BYTES),
    va_CCons(va_code_POP_VOID(FFI_USBTD_Qh32_ParseTargetUSBDevID_ReturnWords * ARCH_WORD_BYTES),
    va_CCons(va_IfElse(va_cmp_eq(va_op_cmp_reg(EDI), va_const_cmp(TRUE)),
    va_Block(va_CCons(va_code_usbpdev_is_empty_addr(va_op_reg_reg(ECX), va_op_reg_reg(EDX),
    va_op_reg_reg(ESI)), va_CCons(va_IfElse(va_cmp_eq(va_op_cmp_reg(ESI), va_const_cmp(FALSE)),
    va_Block(va_CCons(va_code_Load(va_op_word_reg(ESI), va_op_word_reg(EBP), 1 * ARCH_WORD_BYTES),
    va_CCons(va_code_PUSH(va_op_word_reg(ESI)), va_CCons(va_code_usbtd_get_usbpdev_slotid(),
    va_CCons(va_code_Load(va_op_word_reg(ESI), va_op_word_reg(ESP), 0), va_CCons(va_code_POP_VOID(1
    * ARCH_WORD_BYTES), va_CCons(va_code_usbpdev_check_slot_id(va_op_reg_reg(ESI),
    va_op_reg_reg(EAX)), va_CCons(va_IfElse(va_cmp_eq(va_op_cmp_reg(EAX), va_const_cmp(TRUE)),
    va_Block(va_CCons(va_code_PUSH_VOID(1 * ARCH_WORD_BYTES),
    va_CCons(va_code_PUSH(va_op_word_reg(ESI)), va_CCons(va_code_usbpdev_get_id(),
    va_CCons(va_code_Load(va_op_word_reg(EBX), va_op_word_reg(ESP), 0),
    va_CCons(va_code_Load(va_op_word_reg(EAX), va_op_word_reg(ESP), ARCH_WORD_BYTES),
    va_CCons(va_code_POP_VOID(2 * ARCH_WORD_BYTES),
    va_CCons(va_IfElse(va_cmp_eq(va_op_cmp_reg(EDX), va_op_cmp_reg(EBX)),
    va_Block(va_CCons(va_IfElse(va_cmp_eq(va_op_cmp_reg(ECX), va_op_cmp_reg(EAX)),
    va_Block(va_CCons(va_code_MOV_ToReg(va_op_reg_reg(EBX), va_op_word_reg(ESI)),
    va_CCons(va_code_PUSH(va_op_word_reg(EBX)), va_CCons(va_code_usbpdev_get_update_flag(),
    va_CCons(va_code_Load(va_op_word_reg(ECX), va_op_word_reg(ESP), 0), va_CCons(va_code_POP_VOID(1
    * ARCH_WORD_BYTES), va_CCons(va_IfElse(va_cmp_eq(va_op_cmp_reg(ECX),
    va_const_cmp(WimpUSBPDev_Slot_UpdateFlag_Complete)),
    va_Block(va_CCons(va_code_PUSH(va_op_word_reg(EBX)), va_CCons(va_code_usbpdev_get_pid(),
    va_CCons(va_code_Load(va_op_word_reg(ECX), va_op_word_reg(ESP), 0), va_CCons(va_code_POP_VOID(1
    * ARCH_WORD_BYTES), va_CCons(va_code_Load(va_op_word_reg(ESI), va_op_word_reg(EBP), 1 *
    ARCH_WORD_BYTES), va_CCons(va_code_PUSH(va_op_word_reg(ESI)),
    va_CCons(va_code_usbtd_get_td_pid(), va_CCons(va_code_Load(va_op_word_reg(EDX),
    va_op_word_reg(ESP), 0), va_CCons(va_code_POP_VOID(1 * ARCH_WORD_BYTES),
    va_CCons(va_IfElse(va_cmp_eq(va_op_cmp_reg(EDX), va_op_cmp_reg(ECX)),
    va_Block(va_CCons(va_code_Store(va_op_word_reg(EBP), ARCH_WORD_BYTES, va_const_word(TRUE)),
    va_CNil())), va_Block(va_CCons(va_code_Store(va_op_word_reg(EBP), ARCH_WORD_BYTES,
    va_const_word(FALSE)), va_CNil()))), va_CNil()))))))))))),
    va_Block(va_CCons(va_code_Store(va_op_word_reg(EBP), ARCH_WORD_BYTES, va_const_word(FALSE)),
...
lemma{:timeLimitMultiplier 60} va_lemma__usbtd_verify_qh32_step3(va_b0:va_codes, va_s0:va_state,
  va_sN:va_state)
  returns (va_bM:va_codes, va_sM:va_state)
  requires va_require(va_b0, va_code__usbtd_verify_qh32_step3(), va_s0, va_sN)
  ensures  va_ensure(va_b0, va_bM, va_s0, va_sM, va_sN)
  requires va_get_ok(va_s0)
  ensures  va_get_ok(va_sM)
  requires InstSaneState(va_s0)
  ...
  requires !(interrupts_enabled(va_get_sreg(EFLAGS, va_s0)))
  ensures  var td_slot := stack_get_val(va_get_mem(va_s0), va_get_reg(ESP, va_s0)); var ret:word :=
    stack_get_val(va_get_mem(va_sM), va_get_reg(ESP, va_sM)); var pdev_slot :=
    usbtd_map_get_usbpdev_slotid(va_get_globals(va_s0), td_slot); (ret == TRUE ==>
    usbpdev_valid_slot_id(pdev_slot)) && (ret == TRUE ==>
    p__usbtd_verify_qh32_step3_OnSuccessCheck(va_get_globals(va_s0), td_slot, pdev_slot))
  ensures  va_get_reg(ESI, va_sM) == va_get_reg(ESI, va_s0)
  ensures  va_get_reg(EDI, va_sM) == va_get_reg(EDI, va_s0)
  ensures  va_get_reg(ESP, va_sM) == va_get_reg(ESP, va_s0)
  ensures  va_get_reg(EBP, va_sM) == va_get_reg(EBP, va_s0)
  ...
  ensures  va_state_eq(va_sM, va_update_reg(EBP, va_sM, va_update_reg(ESP, va_sM,
    ...
    va_update_mem(va_sM, va_update_ok(va_sM, va_s0)))))))))))
{
  reveal_va_code__usbtd_verify_qh32_step3();
  var va_old_s:va_state := va_s0;
  ghost var va_ltmp1, va_cM:va_code, va_ltmp2 := va_lemma_block(va_b0, va_s0, va_sN);
  va_sM := va_ltmp1;
  va_bM := va_ltmp2;
  var va_b1:va_codes := va_get_block(va_cM);
  reveal_p_ffi_usbtd_qh32_parseTargetUSBDevID_retval();
  reveal_p__usbtd_verify_qh32_step3_OnSuccessCheck();
  ghost var va_b4, va_s4 := va_lemma_PUSH_OneReg(va_b1, va_s0, va_sM, va_op_reg_reg(EBP));
  ghost var va_b5, va_s5 := va_lemma_MOV_ToReg(va_b4, va_s4, va_sM, va_op_reg_reg(EBP),
    va_op_word_reg(ESP));
  ...
  ghost var va_b13, va_s13 := va_lemma_Load(va_b12, va_s12, va_sM, va_op_word_reg(ESI),
    va_op_word_reg(EBP), 1 * ARCH_WORD_BYTES);
  ghost var td_slot := va_get_reg(ESI, va_s13);
  ghost var va_b15, va_s15 := va_lemma_PUSH_VOID(va_b13, va_s13, va_sM,
    (FFI_USBTD_Qh32_ParseTargetUSBDevID_ReturnWords - 1) * ARCH_WORD_BYTES);
  ghost var va_b16, va_s16 := va_lemma_PUSH(va_b15, va_s15, va_sM, va_op_word_reg(ESI));
  ghost var va_b17, va_s17 := va_lemma_CALL_USBTD_QH32_ParseTargetUSBDevID(va_b16, va_s16, va_sM);
  ghost var va_b18, va_s18 := va_lemma_Load(va_b17, va_s17, va_sM, va_op_word_reg(EDI),
    va_op_word_reg(ESP), 0);
  ghost var va_b19, va_s19 := va_lemma_Load(va_b18, va_s18, va_sM, va_op_word_reg(EDX),
    va_op_word_reg(ESP), ARCH_WORD_BYTES);
  ghost var va_b20, va_s20 := va_lemma_Load(va_b19, va_s19, va_sM, va_op_word_reg(ECX),
    va_op_word_reg(ESP), 2 * ARCH_WORD_BYTES);
  ghost var va_b21, va_s21 := va_lemma_POP_VOID(va_b20, va_s20, va_sM,
    FFI_USBTD_Qh32_ParseTargetUSBDevID_ReturnWords * ARCH_WORD_BYTES);
  ghost var dev_addr_high := va_get_reg(ECX, va_s21);
  ghost var dev_addr_low := va_get_reg(EDX, va_s21);
  ghost var dev_addr_raw := UInt64_FromTwoUInt32s(dev_addr_high, dev_addr_low);
  ghost var va_s25, va_c25, va_b25 := va_lemma_block(va_b21, va_s21, va_sM);
  ...
  if (va_cond_c25)
  {
    ...
    assert usbtd_qh32_can_parse_TargetUSBDevID_from_global(va_get_globals(va_s26), td_slot);  // line 526 column 9 of file .\dev/usb2/usb_tds_ops/usb_tds_checks_qh.vad
    ghost var va_b29, va_s29 := va_lemma_usbpdev_is_empty_addr(va_b27, va_s26, va_s25,
      va_op_reg_reg(ECX), va_op_reg_reg(EDX), va_op_reg_reg(ESI));
    ghost var va_s30, va_c30, va_b30 := va_lemma_block(va_b29, va_s29, va_s25);
    ...
    if (va_cond_c30)
    {
      ...
      ghost var empty_addr_raw := UInt64_FromTwoUInt32s(WimpUSBPDev_ADDR_EMPTY_HIGH,
        WimpUSBPDev_ADDR_EMPTY_LOW);
      Lemma_USBPDevAddr_NonEmptyAddrRawParseToNonEmptyAddr(dev_addr_raw);
      assert usb_parse_usbpdev_addr(dev_addr_raw) != usb_parse_usbpdev_addr(empty_addr_raw);  // line 535 column 13 of file .\dev/usb2/usb_tds_ops/usb_tds_checks_qh.vad
      ghost var va_b36, va_s36 := va_lemma_Load(va_b32, va_s31, va_s30, va_op_word_reg(ESI),
        va_op_word_reg(EBP), 1 * ARCH_WORD_BYTES);
      ghost var va_b37, va_s37 := va_lemma_PUSH(va_b36, va_s36, va_s30, va_op_word_reg(ESI));
      ghost var va_b38, va_s38 := va_lemma_usbtd_get_usbpdev_slotid(va_b37, va_s37, va_s30);
      ghost var va_b39, va_s39 := va_lemma_Load(va_b38, va_s38, va_s30, va_op_word_reg(ESI),
        va_op_word_reg(ESP), 0);
      ghost var va_b40, va_s40 := va_lemma_POP_VOID(va_b39, va_s39, va_s30, 1 * ARCH_WORD_BYTES);
      ghost var va_b41, va_s41 := va_lemma_usbpdev_check_slot_id(va_b40, va_s40, va_s30,
        va_op_reg_reg(ESI), va_op_reg_reg(EAX));
      ghost var va_s42, va_c42, va_b42 := va_lemma_block(va_b41, va_s41, va_s30);
      ...
      if (va_cond_c42)
      {
        ...
        ghost var va_b45, va_s45 := va_lemma_PUSH_VOID(va_b44, va_s43, va_s42, 1 * ARCH_WORD_BYTES);
        ghost var va_b46, va_s46 := va_lemma_PUSH(va_b45, va_s45, va_s42, va_op_word_reg(ESI));
        ghost var va_b47, va_s47 := va_lemma_usbpdev_get_id(va_b46, va_s46, va_s42);
        ghost var va_b48, va_s48 := va_lemma_Load(va_b47, va_s47, va_s42, va_op_word_reg(EBX),
          va_op_word_reg(ESP), 0);
        ghost var va_b49, va_s49 := va_lemma_Load(va_b48, va_s48, va_s42, va_op_word_reg(EAX),
          va_op_word_reg(ESP), ARCH_WORD_BYTES);
        ghost var va_b50, va_s50 := va_lemma_POP_VOID(va_b49, va_s49, va_s42, 2 * ARCH_WORD_BYTES);
        ghost var va_s51, va_c51, va_b51 := va_lemma_block(va_b50, va_s50, va_s42);
        ...
        if (va_cond_c51)
        {
          ...
          ghost var va_s54, va_c54, va_b54 := va_lemma_block(va_b53, va_s52, va_s51);
          ghost var va_cond_c54, va_s55:va_state := va_lemma_ifElse(va_get_ifCond(va_c54),
            va_get_ifTrue(va_c54), va_get_ifFalse(va_c54), va_s52, va_s54);
          if (va_cond_c54)
          {
            ghost var va_b56 := va_get_block(va_get_ifTrue(va_c54));
            ghost var va_b57, va_s57 := va_lemma_MOV_ToReg(va_b56, va_s55, va_s54,
              va_op_reg_reg(EBX), va_op_word_reg(ESI));
            ghost var va_b58, va_s58 := va_lemma_PUSH(va_b57, va_s57, va_s54, va_op_word_reg(EBX));
            ghost var va_b59, va_s59 := va_lemma_usbpdev_get_update_flag(va_b58, va_s58, va_s54);
            ghost var va_b60, va_s60 := va_lemma_Load(va_b59, va_s59, va_s54, va_op_word_reg(ECX),
              va_op_word_reg(ESP), 0);
            ghost var va_b61, va_s61 := va_lemma_POP_VOID(va_b60, va_s60, va_s54, 1 *
              ARCH_WORD_BYTES);
            ghost var va_s62, va_c62, va_b62 := va_lemma_block(va_b61, va_s61, va_s54);
            ghost var va_cond_c62, va_s63:va_state := va_lemma_ifElse(va_get_ifCond(va_c62),
              va_get_ifTrue(va_c62), va_get_ifFalse(va_c62), va_s61, va_s62);
            if (va_cond_c62)
            {
              ghost var va_b64 := va_get_block(va_get_ifTrue(va_c62));
              ghost var va_b65, va_s65 := va_lemma_PUSH(va_b64, va_s63, va_s62,
                va_op_word_reg(EBX));
              ghost var va_b66, va_s66 := va_lemma_usbpdev_get_pid(va_b65, va_s65, va_s62);
              ghost var va_b67, va_s67 := va_lemma_Load(va_b66, va_s66, va_s62,
                va_op_word_reg(ECX), va_op_word_reg(ESP), 0);
              ghost var va_b68, va_s68 := va_lemma_POP_VOID(va_b67, va_s67, va_s62, 1 *
                ARCH_WORD_BYTES);
              ghost var va_b69, va_s69 := va_lemma_Load(va_b68, va_s68, va_s62,
                va_op_word_reg(ESI), va_op_word_reg(EBP), 1 * ARCH_WORD_BYTES);
              ghost var va_b70, va_s70 := va_lemma_PUSH(va_b69, va_s69, va_s62,
                va_op_word_reg(ESI));
              ghost var va_b71, va_s71 := va_lemma_usbtd_get_td_pid(va_b70, va_s70, va_s62);
              ghost var va_b72, va_s72 := va_lemma_Load(va_b71, va_s71, va_s62,
                va_op_word_reg(EDX), va_op_word_reg(ESP), 0);
              ghost var va_b73, va_s73 := va_lemma_POP_VOID(va_b72, va_s72, va_s62, 1 *
                ARCH_WORD_BYTES);
              ghost var va_s74, va_c74, va_b74 := va_lemma_block(va_b73, va_s73, va_s62);
              ghost var va_cond_c74, va_s75:va_state := va_lemma_ifElse(va_get_ifCond(va_c74),
                va_get_ifTrue(va_c74), va_get_ifFalse(va_c74), va_s73, va_s74);
              if (va_cond_c74)
              {
                ghost var va_b76 := va_get_block(va_get_ifTrue(va_c74));
                ghost var va_b77, va_s77 := va_lemma_Store(va_b76, va_s75, va_s74,
                  va_op_word_reg(EBP), ARCH_WORD_BYTES, va_const_word(TRUE));
              ...
              else
              {
                ...
                ghost var va_b79, va_s79 := va_lemma_Store(va_b78, va_s75, va_s74,
                  va_op_word_reg(EBP), ARCH_WORD_BYTES, va_const_word(FALSE));
                va_s74 := va_lemma_empty(va_s79, va_s74);
              }
              va_s62 := va_lemma_empty(va_s74, va_s62);
            }
            else
            {
              ghost var va_b80 := va_get_block(va_get_ifFalse(va_c62));
              ghost var va_b81, va_s81 := va_lemma_Store(va_b80, va_s63, va_s62,
                va_op_word_reg(EBP), ARCH_WORD_BYTES, va_const_word(FALSE));
              va_s62 := va_lemma_empty(va_s81, va_s62);
            }
            va_s54 := va_lemma_empty(va_s62, va_s54);
          }
          else
          {
            ghost var va_b82 := va_get_block(va_get_ifFalse(va_c54));
            ghost var va_b83, va_s83 := va_lemma_Store(va_b82, va_s55, va_s54, va_op_word_reg(EBP),
              ARCH_WORD_BYTES, va_const_word(FALSE));
            va_s54 := va_lemma_empty(va_s83, va_s54);
          }
          va_s51 := va_lemma_empty(va_s54, va_s51);
        }
        else
        {
          ghost var va_b84 := va_get_block(va_get_ifFalse(va_c51));
          ghost var va_b85, va_s85 := va_lemma_Store(va_b84, va_s52, va_s51, va_op_word_reg(EBP),
            ARCH_WORD_BYTES, va_const_word(FALSE));
          va_s51 := va_lemma_empty(va_s85, va_s51);
        }
        va_s42 := va_lemma_empty(va_s51, va_s42);
      }
      else
      {
        ghost var va_b86 := va_get_block(va_get_ifFalse(va_c42));
        ghost var va_b87, va_s87 := va_lemma_Store(va_b86, va_s43, va_s42, va_op_word_reg(EBP),
          ARCH_WORD_BYTES, va_const_word(FALSE));
        va_s42 := va_lemma_empty(va_s87, va_s42);
      }
      va_s30 := va_lemma_empty(va_s42, va_s30);
    }
    else
    {
      ghost var va_b88 := va_get_block(va_get_ifFalse(va_c30));
      ghost var va_b89, va_s89 := va_lemma_Store(va_b88, va_s31, va_s30, va_op_word_reg(EBP),
        ARCH_WORD_BYTES, va_const_word(FALSE));
      va_s30 := va_lemma_empty(va_s89, va_s30);
    }
    va_s25 := va_lemma_empty(va_s30, va_s25);
  }
  else
  {
    ghost var va_b90 := va_get_block(va_get_ifFalse(va_c25));
    ghost var va_b91, va_s91 := va_lemma_Store(va_b90, va_s26, va_s25, va_op_word_reg(EBP),
      ARCH_WORD_BYTES, va_const_word(FALSE));
    va_s25 := va_lemma_empty(va_s91, va_s25);
  }
  ghost var va_b92, va_s92 := va_lemma_POP_Reg1ToReg6(va_b25, va_s25, va_sM);
  ghost var va_b93, va_s93 := va_lemma_POP_OneReg(va_b92, va_s92, va_sM, va_op_reg_reg(EBP));
  Lemma_modify_regs_stateeq(va_old_s, va_s93);
  va_sM := va_lemma_empty(va_s93, va_sM);
}
//--
//-- _usbtd_verify_qh32_step4

function method{:opaque} va_code__usbtd_verify_qh32_step4():va_code
{
  va_Block(va_CCons(va_code_PUSH_OneReg(va_op_reg_reg(EBP)),
    va_CCons(va_code_MOV_ToReg(va_op_reg_reg(EBP), va_op_word_reg(ESP)),
    va_CCons(va_code_PUSH_Reg1ToReg6(), va_CCons(va_code_MOV_ToReg(va_op_reg_reg(EAX),
    ...
    va_CCons(va_code_PUSH_VOID((FFI_USBTD_Qh32_ParseDataBufPtrs_ReturnWords - 1) *
    ARCH_WORD_BYTES), va_CCons(va_code_PUSH(va_op_word_reg(ESI)),
    va_CCons(va_code_CALL_USBTD_QH32_ParseBufPointers(), va_CCons(va_code_Load(va_op_word_reg(ESI),
    va_op_word_reg(ESP), 0), va_CCons(va_code_Load(va_op_word_reg(EDI), va_op_word_reg(ESP), 1 *
    ARCH_WORD_BYTES), va_CCons(va_code_Load(va_op_word_reg(EDX), va_op_word_reg(ESP), 2 *
    ARCH_WORD_BYTES), va_CCons(va_code_Load(va_op_word_reg(ECX), va_op_word_reg(ESP), 3 *
    ARCH_WORD_BYTES), va_CCons(va_code_Load(va_op_word_reg(EBX), va_op_word_reg(ESP), 4 *
    ARCH_WORD_BYTES), va_CCons(va_code_POP_VOID(FFI_USBTD_Qh32_ParseDataBufPtrs_ReturnWords *
    ...
    va_CCons(va_code_PUSH(va_op_word_reg(EDI)), va_CCons(va_code_PUSH(va_op_word_reg(ESI)),
...
lemma{:timeLimitMultiplier 30} va_lemma__usbtd_verify_qh32_step4(va_b0:va_codes, va_s0:va_state,
  va_sN:va_state)
  returns (va_bM:va_codes, va_sM:va_state)
  requires va_require(va_b0, va_code__usbtd_verify_qh32_step4(), va_s0, va_sN)
  ensures  va_ensure(va_b0, va_bM, va_s0, va_sM, va_sN)
  requires va_get_ok(va_s0)
  ensures  va_get_ok(va_sM)
  requires InstSaneState(va_s0)
  ...
  ensures  var drv_slot := stack_get_val(va_get_mem(va_s0), va_get_reg(ESP, va_s0)); var drv_id :=
    ...
    stack_get_val(va_get_mem(va_sM), va_get_reg(ESP, va_sM)); ret == TRUE ==>
    p__usbtd_verify_qh32_step4_OnSuccessCheck(va_get_globals(va_s0), drv_slot, td_slot)
  ensures  va_get_reg(ESI, va_sM) == va_get_reg(ESI, va_s0)
  ensures  va_get_reg(EDI, va_sM) == va_get_reg(EDI, va_s0)
  ensures  va_get_reg(ESP, va_sM) == va_get_reg(ESP, va_s0)
  ensures  va_get_reg(EBP, va_sM) == va_get_reg(EBP, va_s0)
  ...
  ensures  va_state_eq(va_sM, va_update_reg(EBP, va_sM, va_update_reg(ESP, va_sM,
    ...
    va_update_mem(va_sM, va_update_ok(va_sM, va_s0)))))))))))
{
  reveal_va_code__usbtd_verify_qh32_step4();
  var va_old_s:va_state := va_s0;
  ghost var va_ltmp1, va_cM:va_code, va_ltmp2 := va_lemma_block(va_b0, va_s0, va_sN);
  va_sM := va_ltmp1;
  va_bM := va_ltmp2;
  var va_b1:va_codes := va_get_block(va_cM);
  reveal_p_ffi_usbtd_qh32_parseDataBufPtrs_retval();
  reveal_p__usbtd_verify_qh32_step4_OnSuccessCheck();
  ghost var va_b4, va_s4 := va_lemma_PUSH_OneReg(va_b1, va_s0, va_sM, va_op_reg_reg(EBP));
  ghost var va_b5, va_s5 := va_lemma_MOV_ToReg(va_b4, va_s4, va_sM, va_op_reg_reg(EBP),
    va_op_word_reg(ESP));
  ghost var va_b12, va_s12 := va_lemma_PUSH_Reg1ToReg6(va_b5, va_s5, va_sM);
  ...
  if (va_cond_c26)
  {
    ...
    ghost var va_b33, va_s33 := va_lemma_PUSH_VOID(va_b31, va_s31, va_s26,
      (FFI_USBTD_Qh32_ParseDataBufPtrs_ReturnWords - 1) * ARCH_WORD_BYTES);
    ghost var va_b34, va_s34 := va_lemma_PUSH(va_b33, va_s33, va_s26, va_op_word_reg(ESI));
    ghost var va_b35, va_s35 := va_lemma_CALL_USBTD_QH32_ParseBufPointers(va_b34, va_s34, va_s26);
...
function method{:opaque} va_code__usbtd_verify_qh32_step1_to_step4():va_code
{
  va_Block(va_CCons(va_code_PUSH_OneReg(va_op_reg_reg(EBP)),
    va_CCons(va_code_MOV_ToReg(va_op_reg_reg(EBP), va_op_word_reg(ESP)),
    ...
    va_CCons(va_code__usbtd_verify_qh32_step1(), va_CCons(va_code_Load(va_op_word_reg(ESI),
    va_op_word_reg(ESP), 0), va_CCons(va_code_POP_VOID(2 * ARCH_WORD_BYTES),
    va_CCons(va_IfElse(va_cmp_eq(va_op_cmp_reg(ESI), va_const_cmp(TRUE)),
    va_Block(va_CCons(va_code_Load(va_op_word_reg(ESI), va_op_word_reg(EBP), 3 * ARCH_WORD_BYTES),
    va_CCons(va_code_PUSH(va_op_word_reg(ESI)), va_CCons(va_code_PUSH(va_op_word_reg(EDI)),
    va_CCons(va_code__usbtd_verify_qh32_step2(), va_CCons(va_code_Load(va_op_word_reg(ESI),
    va_op_word_reg(ESP), 0), va_CCons(va_code_POP_VOID(2 * ARCH_WORD_BYTES),
    va_CCons(va_IfElse(va_cmp_eq(va_op_cmp_reg(ESI), va_const_cmp(TRUE)),
    va_Block(va_CCons(va_code_Load(va_op_word_reg(ESI), va_op_word_reg(EBP), 3 * ARCH_WORD_BYTES),
    va_CCons(va_code_PUSH(va_op_word_reg(ESI)), va_CCons(va_code__usbtd_verify_qh32_step3(),
    va_CCons(va_code_Load(va_op_word_reg(ESI), va_op_word_reg(ESP), 0), va_CCons(va_code_POP_VOID(1
    * ARCH_WORD_BYTES), va_CCons(va_IfElse(va_cmp_eq(va_op_cmp_reg(ESI), va_const_cmp(TRUE)),
    ...
    va_CCons(va_code_PUSH(va_op_word_reg(EDI)), va_CCons(va_code__usbtd_verify_qh32_step4(),
    va_CCons(va_code_Load(va_op_word_reg(ESI), va_op_word_reg(ESP), 0), va_CCons(va_code_POP_VOID(3
    * ARCH_WORD_BYTES), va_CCons(va_IfElse(va_cmp_eq(va_op_cmp_reg(ESI), va_const_cmp(TRUE)),
    va_Block(va_CCons(va_code_Store(va_op_word_reg(EBP), ARCH_WORD_BYTES, va_const_word(TRUE)),
    va_CNil())), va_Block(va_CCons(va_code_Store(va_op_word_reg(EBP), ARCH_WORD_BYTES,
...
lemma{:timeLimitMultiplier 40} va_lemma__usbtd_verify_qh32_step1_to_step4(va_b0:va_codes,
  va_s0:va_state, va_sN:va_state)
  returns (va_bM:va_codes, va_sM:va_state)
  requires va_require(va_b0, va_code__usbtd_verify_qh32_step1_to_step4(), va_s0, va_sN)
  ensures  va_ensure(va_b0, va_bM, va_s0, va_sM, va_sN)
  requires va_get_ok(va_s0)
  ensures  va_get_ok(va_sM)
  requires InstSaneState(va_s0)
  ensures  InstSaneState(va_sM)
  requires var stack_req_space := 4 * ARCH_WORD_BYTES + 9 * ARCH_WORD_BYTES +
    WK_STACK_FOR_EXTERNEL_FUNCS_SZ + FFI_USBTD_Qh32_ParseDataBufPtrs_ReturnWords * ARCH_WORD_BYTES
    + 3 * ARCH_WORD_BYTES; IsAddrInStack(va_get_reg(ESP, va_s0) - stack_req_space) && (var
  ...
  ensures  var drv_slot := stack_get_val(va_get_mem(va_s0), va_get_reg(ESP, va_s0)); var drv_id :=
    stack_get_val(va_get_mem(va_s0), va_get_reg(ESP, va_s0) + 1 * ARCH_WORD_BYTES); var td_slot :=
    stack_get_val(va_get_mem(va_s0), va_get_reg(ESP, va_s0) + 2 * ARCH_WORD_BYTES); var ret:word :=
    stack_get_val(va_get_mem(va_sM), va_get_reg(ESP, va_sM)); ret == TRUE ==> (var drv_pid :=
    wimpdrv_get_pid(va_get_globals(va_s0), drv_slot).v; var pdev_slot :=
    usbtd_map_get_usbpdev_slotid(va_get_globals(va_s0), td_slot);
  ...
  ensures  va_state_eq(va_sM, va_update_reg(EBP, va_sM, va_update_reg(ESP, va_sM,
    ...
    va_update_mem(va_sM, va_update_ok(va_sM, va_s0)))))))))))
{
  reveal_va_code__usbtd_verify_qh32_step1_to_step4();
  var va_old_s:va_state := va_s0;
  ghost var va_ltmp1, va_cM:va_code, va_ltmp2 := va_lemma_block(va_b0, va_s0, va_sN);
  va_sM := va_ltmp1;
  va_bM := va_ltmp2;
  ...
  if (va_cond_c21)
  {
    ...
    ghost var va_b27, va_s27 := va_lemma__usbtd_verify_qh32_step1(va_b26, va_s26, va_s21);
    ...
    if (va_cond_c30)
    {
      ...
      ghost var va_b36, va_s36 := va_lemma__usbtd_verify_qh32_step2(va_b35, va_s35, va_s30);
      ...
      {
        ghost var va_b41 := va_get_block(va_get_ifTrue(va_c39));
        ghost var va_b42, va_s42 := va_lemma_Load(va_b41, va_s40, va_s39, va_op_word_reg(ESI),
          va_op_word_reg(EBP), 3 * ARCH_WORD_BYTES);
        ghost var va_b43, va_s43 := va_lemma_PUSH(va_b42, va_s42, va_s39, va_op_word_reg(ESI));
        ghost var va_b44, va_s44 := va_lemma__usbtd_verify_qh32_step3(va_b43, va_s43, va_s39);
        ghost var va_b45, va_s45 := va_lemma_Load(va_b44, va_s44, va_s39, va_op_word_reg(ESI),
          va_op_word_reg(ESP), 0);
        ghost var va_b46, va_s46 := va_lemma_POP_VOID(va_b45, va_s45, va_s39, 1 * ARCH_WORD_BYTES);
        ghost var va_s47, va_c47, va_b47 := va_lemma_block(va_b46, va_s46, va_s39);
        ghost var va_cond_c47, va_s48:va_state := va_lemma_ifElse(va_get_ifCond(va_c47),
          va_get_ifTrue(va_c47), va_get_ifFalse(va_c47), va_s46, va_s47);
        if (va_cond_c47)
        {
          ghost var va_b49 := va_get_block(va_get_ifTrue(va_c47));
          ...
          ghost var va_b54, va_s54 := va_lemma_Load(va_b53, va_s53, va_s47, va_op_word_reg(EDI),
            va_op_word_reg(EBP), 1 * ARCH_WORD_BYTES);
          ghost var va_b55, va_s55 := va_lemma_PUSH(va_b54, va_s54, va_s47, va_op_word_reg(EDI));
          ghost var va_b56, va_s56 := va_lemma__usbtd_verify_qh32_step4(va_b55, va_s55, va_s47);
          ghost var va_b57, va_s57 := va_lemma_Load(va_b56, va_s56, va_s47, va_op_word_reg(ESI),
            va_op_word_reg(ESP), 0);
          ghost var va_b58, va_s58 := va_lemma_POP_VOID(va_b57, va_s57, va_s47, 3 *
            ARCH_WORD_BYTES);
          ghost var va_s59, va_c59, va_b59 := va_lemma_block(va_b58, va_s58, va_s47);
          ...
          if (va_cond_c59)
          {
            ...
            ghost var va_b62, va_s62 := va_lemma_Store(va_b61, va_s60, va_s59, va_op_word_reg(EBP),
              ARCH_WORD_BYTES, va_const_word(TRUE));
            assert va_get_reg(EDI, va_s62) == drv_slot;  // line 924 column 25 of file .\dev/usb2/usb_tds_ops/usb_tds_checks_qh.vad
            ...
            ghost var wimpdrv_do_pend := wimpdrv_do_get_paddr_end(va_get_globals(va_old_s),
              drv_slot);
            assert wimpdrv_do_pbase <= wimpdrv_do_pend;  // line 929 column 25 of file .\dev/usb2/usb_tds_ops/usb_tds_checks_qh.vad
            assert p__usbtd_verify_qh32_step4_OnSuccessCheck(va_get_globals(va_old_s), drv_slot,
              td_slot);  // line 930 column 25 of file .\dev/usb2/usb_tds_ops/usb_tds_checks_qh.vad
          ...
          va_s47 := va_lemma_empty(va_s59, va_s47);
        }
        else
        {
          ghost var va_b70 := va_get_block(va_get_ifFalse(va_c47));
          ghost var va_b71, va_s71 := va_lemma_Store(va_b70, va_s48, va_s47, va_op_word_reg(EBP),
            ARCH_WORD_BYTES, va_const_word(FALSE));
          va_s47 := va_lemma_empty(va_s71, va_s47);
        }
